  ...
  const contactDetails = [
    {
      ...
      href: "mailto:support@kingfoxclothing.com",
    },
    {
    ...
    },
    {
      ...
      href: "https://www.google.com/maps?q=King+Fox+Clothing+Calicut",
    },
  ];
  ...
  const faqData = [
    {
      ...
      answer:
        "You can track your order using the 'Track Order' button at the top of this page or by clicking the link sent to your email/WhatsApp.",
    },
    {
      question: "HOW DO I CHOOSE THE RIGHT SIZE?",
      answer:
        "Check our size guide available on every product page. If you're between sizes, we usually recommend sizing up for a relaxed street fit.",
    },
    {
      question: "DO YOU ACCEPT INTERNATIONAL ORDERS?",
      answer:
        "Currently, we ship across India. We are working on bringing King Fox clothing to the global stage very soon!",
    },
  ];
        ...
        <div className={styles.formContainer}>
          ...
          <div className={styles.formContent}>
            ...
            <p className={styles.formSubtitle}>
              Fields marked with * are required for our team to process your
              request.
            </p>
              ...
              <div className={styles.deliveryBadge}>
                ...
                <div>
                  ...
                  <p className={styles.badgeText}>
                    ACROSS INDIA ON ORDERS OVER ₹1,999
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className={styles.faqContainer}>
          {faqData.map((item, index) => (
            <div key={index} className={styles.faqItem}>
              ...
              <div
                className={`${styles.faqAnswer} ${openIndex === index ? styles.answerShow : ""}`}
              >
                <p>{item.answer}</p>
              </div>
            </div>
