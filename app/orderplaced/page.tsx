...
export default function OrderConfirmation() {
  ...
  const [order, setOrder] = useState<OrderDetailsResponse | FallbackOrder | null>(
    null,
  );

  useEffect(() => {
    const fetchOrder = async () => {
      const storedOrder = buildStoredOrder(orderId);
  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.orderNumber}>Order #{order.orderNumber || orderId}</p>
      </header>
            ...
            <div>
              ...
              <div className={styles.branchDetails}>
                ...
                <p className={styles.branchAddress}>
                  {order.pickupBranch?.address || "Branch details will be shared soon."}
                </p>
