...
export async function generateMetadata() {
  return createMetadata({
    title: "About — Kingfox",
    description:
      "Learn about Kingfox — our origin, values, and commitment to quality streetwear.",
    pathname: "/about",
  });
}
      ...
      <main className={styles.container}>
        ...
        <header className={styles.hero}>
          ...
          <p className={styles.heroSub}>
            LIVE EVERY DAY BOLDLY — AND SHOW YOUR TRUE <br />
            COLORS.
          </p>
        </header>
        ...
        <section className={styles.contentGrid}>
          ...
          <div className={styles.textContent}>
            ...
            <div className={styles.description}>
              ...
              <p>
                Since 2009, King Fox has been more than just streetwear it’s a
                movement. Born from the streets, fueled by culture, and built
                for those who live loud and move different.
              </p>
              <p>
                Inspired by music, art, skate, and city life, every drop
                reflects raw authenticity and creative hustle. We don’t chase
                trends we set them.
              </p>
              <p>
                From underground roots to global reach, we stay true to what
                matters: quality, identity, and expression.
              </p>
              <p className={styles.legacyText}>
                This is legacy wear. Your Second Skin. <br />
                Stay real. Stay loud.
              </p>
              <span className={styles.bottomTag}>
        ...
        <section className={styles.valuesGrid}>
          <div className={styles.valueCard}>
            ...
            <h4>AUTHENTICITY</h4>
            <p>
              No masks, no pretenses. Real recognize real in every stitch of our
              garments.
            </p>
          </div>
          ...
          <div className={styles.valueCard}>
            ...
            <h4>EXPRESSION</h4>
            <p>
              Your canvas, your rules. Wearable art designed for the creative
              soul.
            </p>
          </div>
          ...
          <div className={styles.valueCard}>
            ...
            <p>
              The pulse of the pavement drives every design decision we make.
            </p>
          </div>
          ...
          <div className={styles.valueCard}>
            ...
            <p>
              Homegrown excellence, crafted meticulously for a global stage.
            </p>
          </div>
        </section>
