...
import { getGuestCart, updateGuestCart, removeGuestCartItem } from "@/lib/cart";
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <p>
          ...
          {token ? cartData?.totalItems || 0 : guestItemCount} items currently
          in cart.
        </p>
      </header>
      ...
      <div className={styles.cartContent}>
        ...
        <div className={styles.itemsList}>
          {/* Normal Orders */}
          {token && cartData?.items && cartData.items.length > 0 && (
            <>
              <h2 className={styles.sectionHeading}>Normal Orders</h2>
